...
sub new
{
    ...
    # verify sm_35 cubin
    #when file is ELF 64-bit LSB relocatable, x86-64, its flags is 0, force Arch to be 35
    #[zxx@ga87 KeplerAs]$ file magma_fermi_sgemm.o
    #magma_fermi_sgemm.o: ELF 64-bit LSB relocatable, x86-64, version 1 (SYSV), not stripped
    ...
    #zxx: I think addressSize should be notificated by e_ident, EI_CLASS
